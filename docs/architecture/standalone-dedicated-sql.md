...
| `SYNAPSE_WORKSPACE_NAME` | **SQL server name** (e.g. `examplesqlserver`) |
...
sma --scope synapse_dedicated_sql:examplesqlserver@<sub>/rg-example-sql analyze-dedicated-pools
```
