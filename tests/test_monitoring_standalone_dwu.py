...
def _standalone_cfg() -> AppConfig:
    azure = AzureConfig(
        ...
        resource_group="rg",
        workspace_name="srv",
        dedicated_pool="exampledwpool",
    )
    scope = SourceDescriptor(
        type=SourceType.SYNAPSE_DEDICATED_SQL,
        id=(
            "/subscriptions/sub/resourceGroups/rg/providers/"
            "Microsoft.Sql/servers/srv/databases/exampledwpool"
        ),
        display_name="exampledwpool",
        subscription_id="sub",
        resource_group="rg",
    )
    return AppConfig(
...
class _FakeMonitoringClient:
    ...
    def list_standalone_dwu_resource_ids(self) -> list[tuple[str, str]]:
        ...
        return [(
            "exampledwpool",
            "/subscriptions/sub/.../databases/exampledwpool",
        )]
